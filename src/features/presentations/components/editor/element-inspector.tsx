...
export function ElementInspector({
  ...
  const labels = getElementInspectorLabels(t);
  return (
    <FieldGroup>
      {element.type === "shape" ? (
        <FieldSet>
      ...
      <FieldSet>
        ...
        <FieldGroup className="gap-4">
          <InspectorGeometryPair
            ...
            onCommit={(position) => onPatchCommit({ position })}
          />
          <InspectorGeometryPair
...
function getElementInspectorLabels(t: ReturnType<typeof useTranslations>) {
