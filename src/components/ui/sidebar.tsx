    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 py-3.5 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
      ...
      >
        <div
          ...
          className="flex size-full flex-col dark:bg-sidebar bg-white group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
